---
name: deck-style-nature
description: Slide deck style — Warm earthy tones with organic shapes and natural imagery. Use when generating a slide deck in the "Nature" style (id: nature).
---

# Nature — slide deck style
