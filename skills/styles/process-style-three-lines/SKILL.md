---
name: process-style-three-lines
description: Process diagram style — Governance view — business / risk & compliance / internal audit. Use when generating a process diagram in the "3 Lines of Defence" style (id: three-lines).
---

# 3 Lines of Defence — process diagram style
