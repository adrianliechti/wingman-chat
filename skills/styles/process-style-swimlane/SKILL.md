---
name: process-style-swimlane
description: Process diagram style — Role-based flowchart that makes cross-team hand-offs explicit. Use when generating a process diagram in the "Swimlane" style (id: swimlane).
---

# Swimlane — process diagram style
