---
name: process-style-itil
description: Process diagram style — Change, incident, problem, or request flows aligned with ITIL. Use when generating a process diagram in the "ITIL / ITSM" style (id: itil).
---

# ITIL / ITSM — process diagram style
