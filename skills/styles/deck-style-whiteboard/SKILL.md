---
name: deck-style-whiteboard
description: Slide deck style — Clean minimal design with hand-drawn feel and open whitespace. Use when generating a slide deck in the "Whiteboard" style (id: whiteboard).
---

# Whiteboard — slide deck style
