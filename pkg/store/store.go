...
// through PutBlob, not event frames. Clients chunk deltas into ~4 MiB
// frames, but a chunk cannot split a single log entry — the headroom is
// for one message carrying megabytes of text (pasted logs, tool results).
