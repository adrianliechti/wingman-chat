/**
 * Minimal PPTX boilerplate templates and JSZip assembly for generating
 * valid PowerPoint files from raw slide XML.
 */
...
export async function downloadPptxFromXml(slideXmls: string[], slug: string) {
