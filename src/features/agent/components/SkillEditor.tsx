            ...
            <Transition.Child as={Fragment} enter="ease-out duration-300" enterFrom="opacity-0 scale-95" enterTo="opacity-100 scale-100" leave="ease-in duration-200" leaveFrom="opacity-100 scale-100" leaveTo="opacity-0 scale-95">
              <Dialog.Panel className="w-full max-w-2xl transform overflow-hidden rounded-xl bg-white/95 dark:bg-neutral-900/95 backdrop-blur-xl shadow-xl transition-all">
                ...
                <div className="flex items-center justify-between px-5 py-3.5 border-b border-neutral-200/60 dark:border-neutral-800/60">
                  <Dialog.Title className="text-base font-semibold text-neutral-900 dark:text-neutral-100">{skill ? "Edit Skill" : "New Skill"}</Dialog.Title>
                ...
                <div className="px-5 py-3.5 space-y-3.5">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs text-neutral-500 dark:text-neutral-400">Lowercase alphanumeric characters and hyphens only. No leading/trailing or consecutive hyphens.</p>
                  </div>
                  ...
                  <div>
                    ...
                    />
                    <p className="mt-1 text-xs text-neutral-500 dark:text-neutral-400">Brief description of the skill's purpose (max 1024 characters).</p>
                  </div>
                  ...
                  <div>
                    ...
                    />
                    <p className="mt-1 text-xs text-neutral-500 dark:text-neutral-400">Markdown content with step-by-step instructions for the agent.</p>
                  </div>
                </div>
