  ...
  return (
    <Menu as="div" className="relative">
      <MenuButton className={buttonClasses} title="Download message" disabled={isConverting}>
        {isConverting ? <Loader2 className={`${className || "h-4 w-4"} animate-spin`} /> : <FileDown className={className || "h-4 w-4"} />}
      </MenuButton>
      <MenuItems
        modal={false}
        transition
      ...
      >
        <MenuItem>
          <button type="button" onClick={handleDownloadWord} className="flex w-full items-center gap-2 px-3 py-2 text-sm text-neutral-700 dark:text-neutral-300 data-focus:bg-neutral-100 dark:data-focus:bg-neutral-700 transition-colors">
            Word (.docx)
          </button>
        </MenuItem>
        <MenuItem>
          <button type="button" onClick={handleDownloadMarkdown} className="flex w-full items-center gap-2 px-3 py-2 text-sm text-neutral-700 dark:text-neutral-300 data-focus:bg-neutral-100 dark:data-focus:bg-neutral-700 transition-colors">
            Markdown (.md)
          </button>
        </MenuItem>
      </MenuItems>
