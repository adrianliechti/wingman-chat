...
export type NodeType = 'searchInput' | 'llm' | 'translate' | 'fileInput' | 'textInput' | 'markdownOutput' | 'audioOutput' | 'imageOutput';
...
export type WorkflowNode = SearchInputNode | LLMNode | TranslateNode | FileInputNode | TextInputNode | MarkdownOutputNode | AudioOutputNode | ImageOutputNode;
